...
.field private final childSubscription:Lrx/g/b;
...
.field private final zipFunction:Lrx/b/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/b/j",
            "<+TR;>;"
...
.method public constructor <init>(Lrx/i;Lrx/b/j;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Lrx/g/b;

    .line 184
    iput-object p1, p0, Lrx/internal/operators/OperatorZip$Zip;->child:Lrx/d;

    .line 185
    iput-object p2, p0, Lrx/internal/operators/OperatorZip$Zip;->zipFunction:Lrx/b/j;

    .line 186
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Lrx/g/b;
...
.method final a()V
    ...
    .line 222
    iget-object v6, p0, Lrx/internal/operators/OperatorZip$Zip;->child:Lrx/d;
    ...
    iget-object v0, v0, Lrx/internal/operators/OperatorZip$Zip$a;->a:Lrx/internal/util/g;

    .line 231
    invoke-virtual {v0}, Lrx/internal/util/g;->f()Ljava/lang/Object;
    ...
    .line 238
    :cond_3
    invoke-static {v0}, Lrx/internal/util/g;->b(Ljava/lang/Object;)Z
    ...
    .line 239
    invoke-interface {v6}, Lrx/d;->aM_()V
    ...
    .line 245
    :cond_4
    invoke-static {v0}, Lrx/internal/util/g;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 252
    :try_start_0
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->zipFunction:Lrx/b/j;

    invoke-interface {v0, v8}, Lrx/b/j;->a([Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    invoke-interface {v6, v0}, Lrx/d;->a(Ljava/lang/Object;)V
    ...
    .line 263
    invoke-virtual {v0}, Lrx/internal/util/g;->e()Ljava/lang/Object;
    ...
    invoke-static {v0, v6, v8}, Lrx/exceptions/a;->a(Ljava/lang/Throwable;Lrx/d;Ljava/lang/Object;)V
...
.method public final a([Lrx/c;Ljava/util/concurrent/atomic/AtomicLong;)V
    .locals 5
    ...
    .line 195
    iget-object v4, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Lrx/g/b;
    ...
    invoke-virtual {v3, v0}, Lrx/c;->a(Lrx/i;)Lrx/j;
