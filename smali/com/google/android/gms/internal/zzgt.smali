...
.method public constructor <init>(Lcom/google/android/gms/internal/zzla;Ljava/util/Map;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/zzgt;->zzAd:Ljava/util/Map;

    invoke-interface {p1}, Lcom/google/android/gms/internal/zzla;->zzjy()Landroid/app/Activity;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/internal/zzgt;->mContext:Landroid/content/Context;

    return-void
.end method

.method static synthetic zza(Lcom/google/android/gms/internal/zzgt;)Landroid/content/Context;
    .locals 1
...
.method public execute()V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/zzgt;->zzas(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzcm;->zzel()Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/internal/zzgt;->zzAd:Ljava/util/Map;
    ...
    :cond_4
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/zzgt;->zzar(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/gms/internal/zzka;->zzaP(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/internal/zzjq;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v4, p0, Lcom/google/android/gms/internal/zzgt;->mContext:Landroid/content/Context;

    invoke-virtual {v1, v4}, Lcom/google/android/gms/internal/zzka;->zzE(Landroid/content/Context;)Landroid/app/AlertDialog$Builder;
    ...
    :goto_5
    new-instance v5, Lcom/google/android/gms/internal/zzgt$1;

    invoke-direct {v5, p0, v0, v2}, Lcom/google/android/gms/internal/zzgt$1;-><init>(Lcom/google/android/gms/internal/zzgt;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_6
    new-instance v1, Lcom/google/android/gms/internal/zzgt$2;

    invoke-direct {v1, p0}, Lcom/google/android/gms/internal/zzgt$2;-><init>(Lcom/google/android/gms/internal/zzgt;)V
...
.method zzar(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method zzi(Ljava/lang/String;Ljava/lang/String;)Landroid/app/DownloadManager$Request;
    .locals 2
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/internal/zzkb;->zza(Landroid/app/DownloadManager$Request;)Z
