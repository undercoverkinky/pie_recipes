...
.field protected b:Lcom/kik/util/cm;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.method public constructor <init>(Lkik/core/datatypes/Message;Ljava/lang/String;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;)V
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/ex;->e:Lkik/core/datatypes/messageExtensions/k;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/ex;->y:Lkik/core/net/messageExtensions/RenderInstructionAttachment;
    ...
    :goto_0
    iput-object v0, p0, Lkik/android/chat/vm/messaging/ex;->z:Lkik/android/chat/vm/messaging/ITextMessageViewModel$TextRenderSize;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/ex;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 5
    ...
    .line 3189
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->z:Lkik/android/chat/vm/messaging/ITextMessageViewModel$TextRenderSize;
    ...
    .line 3194
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->q()Lkik/core/datatypes/Message;
    ...
    .line 3196
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->c:Lkik/core/interfaces/ad;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/ex;Lkik/core/datatypes/Message;)Ljava/lang/Boolean;
    .locals 1

    .prologue
    .line 249
    invoke-virtual {p0, p1}, Lkik/android/chat/vm/messaging/ex;->c(Lkik/core/datatypes/Message;)Z
    ...
    .line 250
    invoke-virtual {p0, p1}, Lkik/android/chat/vm/messaging/ex;->a(Lkik/core/datatypes/Message;)Z
    ...
    .line 251
    invoke-virtual {p0, p1}, Lkik/android/chat/vm/messaging/ex;->b(Lkik/core/datatypes/Message;)Z
...
.method static synthetic a(Lkik/android/chat/vm/messaging/ex;)V
    ...
    .prologue
    .line 173
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->b:Lcom/kik/util/cm;

    const-string v1, ""

    invoke-direct {p0}, Lkik/android/chat/vm/messaging/ex;->aj()Ljava/lang/String;

    move-result-object v2

    invoke-interface {v0, v1, v2}, Lcom/kik/util/cm;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private aj()Ljava/lang/String;
    ...
    .prologue
    .line 89
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->h:Lkik/core/interfaces/IConversation;

    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->n()Ljava/lang/String;
    ...
    .line 101
    :cond_0
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->aG_()Z
    ...
    .line 102
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->m:Landroid/content/res/Resources;
    ...
    :cond_1
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->e:Lkik/core/datatypes/messageExtensions/k;
...
.method static synthetic b(Lkik/android/chat/vm/messaging/ex;)Ljava/lang/String;
    .locals 1
...
.method public final N()Lrx/d;
    ...
    .prologue
    .line 248
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->aH_()Lrx/d;

    move-result-object v0

    invoke-static {p0}, Lkik/android/chat/vm/messaging/fg;->a(Lkik/android/chat/vm/messaging/ex;)Lrx/functions/g;
...
.method public final Q()Lrx/d;
    ...
    .prologue
    .line 179
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->C()Lrx/d;

    move-result-object v0

    invoke-static {p0}, Lkik/android/chat/vm/messaging/ff;->a(Lkik/android/chat/vm/messaging/ex;)Lrx/functions/g;
...
.method public final U()V
    ...
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->H()Lkik/android/chat/vm/messaging/AbstractMessageViewModel$a;
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 204
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->a:Lcom/kik/android/Mixpanel;
    ...
    invoke-static {v0}, Lcom/kik/util/cq;->a(Landroid/net/Uri;)Z
    ...
    .line 220
    :goto_0
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->F_()Lkik/android/chat/vm/ay;
    ...
    .line 216
    invoke-static {p3}, Lkik/android/chat/vm/messaging/ex;->d(Ljava/lang/String;)Z
...
.method public final aC_()Ljava/util/List;
    ...
    iget-object v3, p0, Lkik/android/chat/vm/messaging/ex;->m:Landroid/content/res/Resources;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/fe;->a(Lkik/android/chat/vm/messaging/ex;)Ljava/lang/Runnable;
...
.method public final an_()Lrx/d;
    ...
    .prologue
    .line 141
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->Q()Lrx/d;

    move-result-object v0

    invoke-static {}, Lkik/android/chat/vm/messaging/fb;->a()Lrx/functions/g;
...
.method public final ap_()Lcom/kik/message/model/attachments/RenderInstructionSet;
    .locals 4
    ...
    .line 159
    iget-object v1, p0, Lkik/android/chat/vm/messaging/ex;->g:Lkik/core/interfaces/v;

    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->s()Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, Lkik/android/chat/vm/messaging/ex;->y:Lkik/core/net/messageExtensions/RenderInstructionAttachment;

    if-eqz v1, :cond_0

    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->y:Lkik/core/net/messageExtensions/RenderInstructionAttachment;
...
.method public final aq_()V
    ...
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/ex;->ah_()Lkik/android/chat/vm/j;
...
.method public final g()Lrx/d;
    ...
    .line 112
    iget-object v0, p0, Lkik/android/chat/vm/messaging/ex;->d:Lcom/kik/android/b/g;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/ey;->a(Lkik/android/chat/vm/messaging/ex;)Lrx/functions/g;
...
.method public final l()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/fa;->a(Lkik/android/chat/vm/messaging/ex;)Lrx/functions/g;
...
.method public final o()Lrx/d;
    ...
    .line 153
    invoke-static {}, Lkik/android/chat/vm/messaging/fd;->a()Lrx/functions/g;
