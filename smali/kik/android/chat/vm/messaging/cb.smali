.class public final Lkik/android/chat/vm/messaging/cb;
...
.field private s:Lkik/android/chat/vm/messaging/ca;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkik/android/chat/vm/messaging/cb;->e:Lorg/slf4j/b;
...
.method public constructor <init>(Lrx/d;Ljava/util/concurrent/Executor;Lkik/android/internal/platform/PlatformHelper;)V
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->f:Lrx/subjects/a;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->g:Lrx/subjects/a;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->h:Lrx/subjects/a;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->i:Lrx/subjects/a;

    .line 50
    const/4 v0, -0x1

    iput v0, p0, Lkik/android/chat/vm/messaging/cb;->k:I
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->n:Lrx/subjects/PublishSubject;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->q:Lrx/g;

    .line 60
    invoke-static {p0}, Lkik/android/chat/vm/messaging/cc;->a(Lkik/android/chat/vm/messaging/cb;)Lrx/functions/b;

    move-result-object v0

    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->r:Lrx/functions/b;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->u:Lrx/g;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->v:Lrx/g;

    .line 78
    iput-object p1, p0, Lkik/android/chat/vm/messaging/cb;->j:Lrx/d;

    .line 79
    iput-object p2, p0, Lkik/android/chat/vm/messaging/cb;->l:Ljava/util/concurrent/Executor;

    .line 80
    iput-object p3, p0, Lkik/android/chat/vm/messaging/cb;->t:Lkik/android/internal/platform/PlatformHelper;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->s:Lkik/android/chat/vm/messaging/ca;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/cb;Ljava/lang/String;Ljava/lang/Boolean;)Lrx/d;
    .locals 2
    ...
    .line 227
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->c:Lkik/android/voice/g;

    invoke-interface {v0}, Lkik/android/voice/g;->a()V

    .line 228
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->b:Lkik/android/voice/e;

    iget v1, p0, Lkik/android/chat/vm/messaging/cb;->k:I
...
.method private a(ILrx/functions/a;)V
    ...
    .prologue
    .line 135
    invoke-direct {p0}, Lkik/android/chat/vm/messaging/cb;->w()V
    ...
    iget-object v5, p0, Lkik/android/chat/vm/messaging/cb;->q:Lrx/g;

    invoke-static/range {v0 .. v5}, Lrx/d;->a(JJLjava/util/concurrent/TimeUnit;Lrx/g;)Lrx/d;

    move-result-object v0

    iget-object v1, p0, Lkik/android/chat/vm/messaging/cb;->v:Lrx/g;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/ci;->a(Lkik/android/chat/vm/messaging/cb;)Lrx/functions/b;
    ...
    iput-object v0, p0, Lkik/android/chat/vm/messaging/cb;->p:Lrx/k;

    .line 142
    return-void
.end method

.method static synthetic a(Lkik/android/chat/vm/messaging/cb;)V
    .locals 0

    .prologue
    .line 118
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/cb;->e()V

    return-void
.end method

.method static synthetic a(Lkik/android/chat/vm/messaging/cb;I)V
    .locals 5
    ...
    iget-object v1, p0, Lkik/android/chat/vm/messaging/cb;->a:Lkik/android/voice/f;
    ...
    .line 11157
    iget-object v2, p0, Lkik/android/chat/vm/messaging/cb;->d:Lcom/rounds/kik/analytics/IReporter;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/cb;Ljava/lang/Boolean;)V
    .locals 1
    ...
    .line 98
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/cb;->b()V
...
.method static synthetic a(Lkik/android/chat/vm/messaging/cb;Ljava/lang/Integer;)V
    .locals 1

    .prologue
    .line 139
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->n:Lrx/subjects/PublishSubject;
    ...
    iput v0, p0, Lkik/android/chat/vm/messaging/cb;->o:I

    .line 141
    return-void
.end method

.method static synthetic a(Lkik/android/chat/vm/messaging/cb;Ljava/lang/Throwable;)V
    .locals 2
    ...
    .line 248
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->h:Lrx/subjects/a;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/cb;Lkik/core/datatypes/messageExtensions/ContentMessage;Ljava/lang/Float;)V
    .locals 3

    .prologue
    .line 237
    .line 10254
    iget v0, p0, Lkik/android/chat/vm/messaging/cb;->k:I
    ...
    .line 10255
    iget-object v1, p0, Lkik/android/chat/vm/messaging/cb;->d:Lcom/rounds/kik/analytics/IReporter;
...
.method static synthetic b(Lkik/android/chat/vm/messaging/cb;Ljava/lang/Integer;)V
    .locals 2

    .prologue
    .line 61
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->g:Lrx/subjects/a;
    ...
    .line 12147
    iget-object v1, p0, Lkik/android/chat/vm/messaging/cb;->l:Ljava/util/concurrent/Executor;

    invoke-static {p0, v0}, Lkik/android/chat/vm/messaging/cj;->a(Lkik/android/chat/vm/messaging/cb;I)Ljava/lang/Runnable;
    ...
    .line 63
    iget v0, p0, Lkik/android/chat/vm/messaging/cb;->m:I

    invoke-static {}, Lkik/android/chat/vm/messaging/ce;->b()Lrx/functions/a;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Lkik/android/chat/vm/messaging/cb;->a(ILrx/functions/a;)V
...
.method private w()V
    ...
    .prologue
    .line 126
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->p:Lrx/k;
...
.method private x()Z
    ...
    .prologue
    .line 293
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->f:Lrx/subjects/a;
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/ay;)V
    ...
    .prologue
    .line 93
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lkik/android/chat/vm/messaging/cb;)V

    .line 94
    invoke-super {p0, p1, p2}, Lkik/android/chat/vm/e;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/ay;)V

    .line 95
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->s:Lkik/android/chat/vm/messaging/ca;

    invoke-virtual {v0, p1, p2}, Lkik/android/chat/vm/messaging/ca;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/ay;)V

    .line 96
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/cb;->ad_()Lrx/f/b;

    move-result-object v0

    iget-object v1, p0, Lkik/android/chat/vm/messaging/cb;->j:Lrx/d;

    invoke-static {p0}, Lkik/android/chat/vm/messaging/cf;->a(Lkik/android/chat/vm/messaging/cb;)Lrx/functions/b;
...
.method public final ak_()V
    ...
    invoke-virtual {v0}, Lkik/android/chat/vm/messaging/ca;->ak_()V
...
.method public final b()V
    ...
    .line 107
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->a:Lkik/android/voice/f;
...
.method public final d()V
    ...
    .line 116
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->d:Lcom/rounds/kik/analytics/IReporter;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/cg;->a(Lkik/android/chat/vm/messaging/cb;)Lrx/functions/a;
...
.method public final e()V
    ...
    .prologue
    .line 169
    invoke-direct {p0}, Lkik/android/chat/vm/messaging/cb;->x()Z
    ...
    .line 173
    :cond_0
    iget v0, p0, Lkik/android/chat/vm/messaging/cb;->o:I

    iput v0, p0, Lkik/android/chat/vm/messaging/cb;->m:I
...
.method public final l()V
    ...
    .line 206
    iget-object v1, p0, Lkik/android/chat/vm/messaging/cb;->f:Lrx/subjects/a;
...
.method public final m()V
    ...
    .line 216
    iget-object v2, p0, Lkik/android/chat/vm/messaging/cb;->f:Lrx/subjects/a;
    ...
    .line 218
    iget-object v2, p0, Lkik/android/chat/vm/messaging/cb;->b:Lkik/android/voice/e;
    ...
    .line 221
    iget-object v2, p0, Lkik/android/chat/vm/messaging/cb;->i:Lrx/subjects/a;
    ...
    iget-object v3, p0, Lkik/android/chat/vm/messaging/cb;->a:Lkik/android/voice/f;
    ...
    invoke-static {p0, v0}, Lkik/android/chat/vm/messaging/ck;->a(Lkik/android/chat/vm/messaging/cb;Ljava/lang/String;)Lrx/functions/g;
    ...
    iget-object v3, p0, Lkik/android/chat/vm/messaging/cb;->u:Lrx/g;
    ...
    iget-object v3, p0, Lkik/android/chat/vm/messaging/cb;->v:Lrx/g;
    ...
    invoke-static {p0, v1}, Lkik/android/chat/vm/messaging/cl;->a(Lkik/android/chat/vm/messaging/cb;Lkik/core/datatypes/messageExtensions/ContentMessage;)Lrx/functions/b;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/vm/messaging/cm;->a(Lkik/android/chat/vm/messaging/cb;)Lrx/functions/b;
...
.method public final o()Lrx/d;
    ...
    .prologue
    .line 275
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->j:Lrx/d;
...
.method public final p()Lrx/d;
    ...
    .line 9275
    iget-object v2, p0, Lkik/android/chat/vm/messaging/cb;->j:Lrx/d;
...
.method public final s()Lrx/d;
    ...
    .prologue
    .line 305
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->i:Lrx/subjects/a;
...
.method public final u()Lrx/functions/b;
    ...
    .prologue
    .line 322
    iget-object v0, p0, Lkik/android/chat/vm/messaging/cb;->r:Lrx/functions/b;
