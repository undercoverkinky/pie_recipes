...
.field private H:Landroid/support/v7/internal/app/AppCompatViewInflater;

.field k:Landroid/support/v7/view/ActionMode;
...
.field private o:Landroid/support/v7/internal/widget/DecorContentParent;

.field private p:Landroid/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback;

.field private q:Landroid/support/v7/app/AppCompatDelegateImplV7$PanelMenuPresenterCallback;
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->m()Z
    ...
    .line 8674
    sget v5, Landroid/support/v7/appcompat/R$attr;->a:I
    ...
    .line 8692
    sget-object v0, Landroid/support/v7/appcompat/R$styleable;->bH:[I
    ...
    .line 8693
    sget v1, Landroid/support/v7/appcompat/R$styleable;->bK:I
    ...
    .line 8695
    sget v1, Landroid/support/v7/appcompat/R$styleable;->bI:I
    ...
    .line 8684
    :cond_c
    sget v1, Landroid/support/v7/appcompat/R$style;->a:I
    ...
    .line 9055
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->q:Landroid/support/v7/app/AppCompatDelegateImplV7$PanelMenuPresenterCallback;
    ...
    invoke-direct {v0, p0, v3}, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelMenuPresenterCallback;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;B)V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->q:Landroid/support/v7/app/AppCompatDelegateImplV7$PanelMenuPresenterCallback;
    ...
    .line 9715
    :cond_10
    iget-object v1, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
    ...
    sget v5, Landroid/support/v7/appcompat/R$layout;->k:I

    invoke-direct {v1, v4, v5}, Landroid/support/v7/internal/view/menu/ListMenuPresenter;-><init>(Landroid/content/Context;I)V

    iput-object v1, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/ListMenuPresenter;

    .line 9718
    iget-object v1, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/ListMenuPresenter;

    invoke-virtual {v1, v0}, Landroid/support/v7/internal/view/menu/ListMenuPresenter;->a(Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;)V
    ...
    .line 9722
    :cond_11
    iget-object v0, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/internal/widget/DecorContentParent;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/internal/widget/DecorContentParent;

    invoke-interface {v0}, Landroid/support/v7/internal/widget/DecorContentParent;->d()Z
...
.method static synthetic a(Landroid/support/v7/app/AppCompatDelegateImplV7;I)V
    ...
    .line 89
    .line 13378
    invoke-direct {p0, p1}, Landroid/support/v7/app/AppCompatDelegateImplV7;->d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
    ...
    .line 13396
    invoke-direct {p0, v3}, Landroid/support/v7/app/AppCompatDelegateImplV7;->d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
...
.method static synthetic b(Landroid/support/v7/app/AppCompatDelegateImplV7;I)I
    ...
    invoke-static {v5, v1, v4}, Landroid/support/v7/internal/widget/ViewUtils;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    sget v5, Landroid/support/v7/appcompat/R$color;->a:I
...
.method private b(Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/DecorContentParent;->i()V
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/DecorContentParent;->h()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->k()Landroid/support/v7/app/ActionBar;
    ...
    .line 12010
    sget v0, Landroid/support/v7/appcompat/R$attr;->f:I
    ...
    .line 12017
    sget v9, Landroid/support/v7/appcompat/R$attr;->g:I
    ...
    invoke-direct {v0, v2, v4}, Landroid/support/v7/internal/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V
    ...
    .line 12039
    invoke-virtual {v2, p0}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/support/v7/internal/view/menu/MenuBuilder$Callback;)V
    ...
    .line 1108
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->p:Landroid/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback;

    if-nez v0, :cond_d

    .line 1109
    new-instance v0, Landroid/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback;

    invoke-direct {v0, p0, v4}, Landroid/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;B)V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->p:Landroid/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback;

    .line 1111
    :cond_d
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/internal/widget/DecorContentParent;

    iget-object v2, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/internal/view/menu/MenuBuilder;

    iget-object v5, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->p:Landroid/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback;

    invoke-interface {v0, v2, v5}, Landroid/support/v7/internal/widget/DecorContentParent;->a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;)V
    ...
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->p:Landroid/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback;

    invoke-interface {v0, v1, v2}, Landroid/support/v7/internal/widget/DecorContentParent;->a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;)V
...
.method private d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
    .locals 4
...
.method static synthetic d(Landroid/support/v7/app/AppCompatDelegateImplV7;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
...
.method private o()V
    ...
    .line 277
    sget v1, Landroid/support/v7/appcompat/R$layout;->g:I
    ...
    sget v2, Landroid/support/v7/appcompat/R$attr;->f:I
    ...
    sget v1, Landroid/support/v7/appcompat/R$layout;->p:I
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/internal/widget/DecorContentParent;

    .line 304
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/internal/widget/DecorContentParent;

    .line 2233
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->b:Landroid/view/Window;
    ...
    .line 304
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/DecorContentParent;->a(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/DecorContentParent;->a(I)V
    ...
    .line 321
    sget v1, Landroid/support/v7/appcompat/R$layout;->o:I
    ...
    .line 324
    :cond_6
    sget v1, Landroid/support/v7/appcompat/R$layout;->n:I
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/FitWindowsViewGroup;->a(Landroid/support/v7/internal/widget/FitWindowsViewGroup$OnFitSystemWindowsListener;)V
    ...
    sget v1, Landroid/support/v7/appcompat/R$id;->U:I
    ...
    invoke-static {v0}, Landroid/support/v7/internal/widget/ViewUtils;->b(Landroid/view/View;)V
    ...
    sget v2, Landroid/support/v7/appcompat/R$id;->c:I
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->s:Landroid/view/ViewGroup;
    ...
    sget-object v2, Landroid/support/v7/appcompat/R$styleable;->bH:[I
    ...
    .line 2437
    sget v2, Landroid/support/v7/appcompat/R$styleable;->bS:I
    ...
    .line 2438
    sget v2, Landroid/support/v7/appcompat/R$styleable;->bT:I
    ...
    .line 2440
    sget v2, Landroid/support/v7/appcompat/R$styleable;->bQ:I
    ...
    .line 2444
    :cond_d
    sget v2, Landroid/support/v7/appcompat/R$styleable;->bR:I
    ...
    .line 2452
    :cond_f
    sget v2, Landroid/support/v7/appcompat/R$styleable;->bP:I
    ...
    .line 417
    invoke-direct {p0, v5}, Landroid/support/v7/app/AppCompatDelegateImplV7;->d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
...
.method final a(Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/view/ActionMode;
    ...
    .line 590
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->k:Landroid/support/v7/view/ActionMode;
    ...
    .line 612
    sget v5, Landroid/support/v7/appcompat/R$attr;->f:I
    ...
    iput-object v5, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->l:Landroid/support/v7/internal/widget/ActionBarContextView;

    .line 627
    new-instance v5, Landroid/widget/PopupWindow;

    sget v6, Landroid/support/v7/appcompat/R$attr;->i:I

    invoke-direct {v5, v0, v7, v6}, Landroid/widget/PopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v5, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/widget/PopupWindow;

    .line 629
    iget-object v5, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/widget/PopupWindow;
    ...
    sget v6, Landroid/support/v7/appcompat/R$attr;->b:I
    ...
    .line 636
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->l:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/internal/widget/ActionBarContextView;->a(Landroid/support/v7/view/ActionMode;)V
    ...
    .line 664
    iput-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->k:Landroid/support/v7/view/ActionMode;
    ...
    sget v4, Landroid/support/v7/appcompat/R$id;->i:I
    ...
    .line 675
    :cond_7
    iput-object v7, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->k:Landroid/support/v7/view/ActionMode;
...
.method public final a(Landroid/os/Bundle;)V
    ...
    .line 146
    invoke-super {p0, p1}, Landroid/support/v7/app/AppCompatDelegateImplBase;->a(Landroid/os/Bundle;)V
...
.method public final a(Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/DecorContentParent;->c()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/DecorContentParent;->e()Z
    ...
    .line 3965
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/internal/widget/DecorContentParent;

    invoke-interface {v1}, Landroid/support/v7/internal/widget/DecorContentParent;->d()Z
    ...
    .line 3974
    :cond_1
    invoke-direct {p0, v4}, Landroid/support/v7/app/AppCompatDelegateImplV7;->d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/DecorContentParent;->f()Z
    ...
    invoke-interface {v1}, Landroid/support/v7/internal/widget/DecorContentParent;->g()Z
...
.method final a(ILandroid/view/KeyEvent;)Z
    ...
    .line 728
    invoke-direct {p0, v1}, Landroid/support/v7/app/AppCompatDelegateImplV7;->d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
...
.method public final a(Landroid/support/v7/internal/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    .line 539
    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/MenuBuilder;->o()Landroid/support/v7/internal/view/menu/MenuBuilder;
...
.method final a(Landroid/view/KeyEvent;)Z
    ...
    .line 5226
    invoke-direct {p0, v2}, Landroid/support/v7/app/AppCompatDelegateImplV7;->d(I)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;

    move-result-object v0

    .line 5227
    iget-boolean v4, v0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->o:Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/DecorContentParent;->g()Z
    ...
    .line 6253
    :cond_9
    iget-boolean v0, v4, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->o:Z

    if-nez v0, :cond_a

    iget-boolean v0, v4, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->n:Z

    if-eqz v0, :cond_b

    .line 6256
    :cond_a
    iget-boolean v3, v4, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->o:Z
    ...
    .line 6261
    iget-boolean v0, v4, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->r:Z

    if-eqz v0, :cond_11

    .line 6264
    iput-boolean v2, v4, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->m:Z
...
.method final b(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/DecorContentParent;->a(Ljava/lang/CharSequence;)V
...
.method public final j()Landroid/support/v7/app/ActionBar;
    .locals 3
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 6791
    :goto_1
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->H:Landroid/support/v7/internal/app/AppCompatViewInflater;
    ...
    invoke-direct {v2}, Landroid/support/v7/internal/app/AppCompatViewInflater;-><init>()V

    iput-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->H:Landroid/support/v7/internal/app/AppCompatViewInflater;
    ...
    .line 6806
    :goto_2
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->H:Landroid/support/v7/internal/app/AppCompatViewInflater;
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v7/internal/app/AppCompatViewInflater;->a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/view/View;
